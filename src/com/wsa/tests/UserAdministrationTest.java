...
import com.wsa.pages.UserAdministration;
...
public class UserAdministrationTest extends MyTestNGBaseClass{
	@Test		
	public void validation() throws Throwable
	{
		...
		AssertJUnit.assertTrue(obj1.fGoToUserAdminstration());
		
		
		UserAdministration obj2 = new UserAdministration(oDriver,oExtentReport,oExtentTest,dataMap);
		
		AssertJUnit.assertTrue(obj2.fCreateUser());
		AssertJUnit.assertTrue(obj2.fSearchUser());
	}
}
